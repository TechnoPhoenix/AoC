...
public class Problem1 {
	...
	public static void main(String[] args) {
		...
		for(Trio element : trios) {
			if(element.a.charAt(0) == 't' || element.b.charAt(0) == 't' || element.c.charAt(0) == 't') {
				counter++;
			}
		}
		counter /= 6;
		...
		//output
		System.out.println("The number of sets with at least one computer starting with the letter t is: " + counter);
	}
