...
public class Problem2 {
	...
	public static void main(String[] args) {
		...
		String input = inputToString("src/Day23_2024_12_23/input.txt");
		...
		for(String str : input.split("\n")) {
			...
			ArrayList<String> aSet = graph.getOrDefault(a, new ArrayList<String>());
			ArrayList<String> bSet = graph.getOrDefault(b, new ArrayList<String>());
			aSet.add(b);
			bSet.add(a);
			graph.put(a, aSet);
			graph.put(b, bSet);
	...
	private static void recursiveBronKerbosch(ArrayList<String> r, ArrayList<String> p ,ArrayList<String> x) {
		if(p.isEmpty()) {
			if(x.isEmpty()) {
				cliques.add(r);
			}
