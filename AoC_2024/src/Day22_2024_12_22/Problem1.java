...
public class Problem1 {
	...
	public static void main(String[] args) {
		...
		String input = inputToString("src/Day22_2024_12_22/input.txt");
		...
		//output
		System.out.println("The sum of all buyers 200th secret numbers is: " + sumOfNumbers);
	}
