...
public class Problem2 {
	...
	private static long calcReqTokens(int xDiffA, int yDiffA, int xDiffB, int yDiffB, long xPrize, long yPrize) {
		long bPresses = ((yDiffA * xPrize) - (xDiffA * yPrize)) / (yDiffA*xDiffB - xDiffA*yDiffB);
