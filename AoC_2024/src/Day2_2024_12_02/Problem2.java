...
public class Problem2 {
	...
	public static void main(String[] args) {
		...
		String input = inputToString("src/Day2_2024_12_02/input.txt");
		...
		//print result
		System.out.println("The total number of safe reports with the problem dampener is: " + safeCounter);
	}
