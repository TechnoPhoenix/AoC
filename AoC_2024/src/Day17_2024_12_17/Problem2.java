...
public class Problem2 {
	...
	public static void main(String[] args) {
		...
		//output
		System.out.println("The initial value for register A is: " + initialRegisterA);
	}

	private static boolean recursiveOutputAttempts(int depth) {
		if(depth == bitSegments.length) { return true; }
		...
		for(int i = 0; i < 8; i++) {
			...
			long resultingOutput = ((((A % 8) ^ 5) ^ 6) ^ (long)(A / (Math.pow(2 , ((A % 8) ^ 5))))) % 8;
