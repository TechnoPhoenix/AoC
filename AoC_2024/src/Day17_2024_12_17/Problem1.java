...
public class Problem1 {
	...
	public static void main(String[] args) {
		...
		String input = inputToString("src/Day17_2024_12_17/input.txt");

		//extract registers and program from input
		String[] registers = input.split("\n\n")[0].split("\n");
		String programString = input.split("\n\n")[1];
		String[] programArr = programString.substring(9, programString.length()).trim().split(",");
			...
			switch(program[ip]) {
				case 0:
					...
					switch(comboOperand) {
						...
						case 3:
							...
							registerA = (long)(registerA/(Math.pow(2d, (double)comboOperand)));
							break;
						case 4:
							//combo operand as register A
							registerA = (long)(registerA/(Math.pow(2d, (double)registerA)));
							break;
						case 5:
							//combo operand as register B
							registerA = (long)(registerA/(Math.pow(2d, (double)registerB)));
							break;
						case 6:
							//combo operand as register C
							registerA = (long)(registerA/(Math.pow(2d, (double)registerC)));
							break;
						case 7:
				...
				case 6:
					...
					switch(comboOperand) {
						...
						case 3:
							//combo operand as literal value
							registerB = (long)(registerA/(Math.pow(2d, (double)comboOperand)));
							break;
						case 4:
							//combo operand as register A
							registerB = (long)(registerA/(Math.pow(2d, (double)registerA)));
							break;
						case 5:
							//combo operand as register B
							registerB = (long)(registerA/(Math.pow(2d, (double)registerB)));
							break;
						case 6:
							//combo operand as register C
							registerB = (long)(registerA/(Math.pow(2d, (double)registerC)));
							break;
						case 7:
						System.out.println("Invalid combo operand");
					}
				...
				case 7:
					...
					switch(comboOperand) {
						...
						case 3:
							//combo operand as literal value
							registerC = (long)(registerA/(Math.pow(2d, (double)comboOperand)));
							break;
						case 4:
							//combo operand as register A
							registerC = (long)(registerA/(Math.pow(2d, (double)registerA)));
							break;
						case 5:
							//combo operand as register B
							registerC = (long)(registerA/(Math.pow(2d, (double)registerB)));
							break;
						case 6:
							//combo operand as register C
							registerC = (long)(registerA/(Math.pow(2d, (double)registerC)));
							break;
						case 7:
						System.out.println("Invalid combo operand");
					}
