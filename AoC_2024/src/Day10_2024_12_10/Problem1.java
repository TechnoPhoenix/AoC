...
public class Problem1 {
	...
	public static void main(String[] args) {
		...
		String input = inputToString("src/Day10_2024_12_10/input.txt");
		...
		System.out.println("The sum of the scores of all trailheads is: " + totalScore);
	}
	...
	private static void recTraverse(int i, int j, int[][] map, int reqHeight, boolean[][] trailTails) {
		try{
			if(reqHeight == 9) {
				if(map[i][j] == 9) {
					trailTails[i][j] = true;
