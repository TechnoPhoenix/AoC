...
public class Y2024_D18_P2 {
    ...
    public static void main(String[] args) {
        ...
        //output
        System.out.println(
            "The coordinates of the first byte blocking the path is:\n" +
                bytes[byteCounter].xPos +
                "," +
                bytes[byteCounter].yPos
        );
    }
    ...
    private static boolean reachable(char[][] map) {
        ...
        return !(
            locationSteps
                .getOrDefault(new Coords(70, 70), Integer.MAX_VALUE)
                .intValue() ==
            Integer.MAX_VALUE
        );
    }
